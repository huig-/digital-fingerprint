...
groups = "groups.txt"
results = os.path.join(path, cluster, "Results", "clusters.txt")
corr_path = os.path.join(path, cluster, "Results", "corr.npy")
elements = os.path.join(path, cluster, "Results", "elements.txt")
